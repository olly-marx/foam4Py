...
void pyBlockMesh::generateMesh(int argc, char *argv[])
{
...
#include "setRootCase.H"
    ...
    Time runTime(foamCase_.getControlDict(), rootPath, caseName,
    ...
    Foam::blockMesh blocks = Foam::blockMesh(meshDict, regionName);
