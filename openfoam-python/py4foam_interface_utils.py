...
A script that contains utility functions for the pyBindFOAM interface.

Author: Oliver Marx
Email: oliver.j.marx@gmail.com

Description:
    This script contains utility functions for the pyBindFOAM interface. The functions
...
Usage: 
    The functions in this script are called by the pyBindFOAM interface.
...
def import_project():
    ...
    editor = dictionaryEditor.DictionaryEditor(project_dir)
...
def view(state):
    ...
    if state.state == s.STATE.VIEW:
        ...
        if dictionary_name in state.dictionaries:
            ...
            print("------------------------------------------------------------")
            out.print_dict(state.dictionaries, dictionary_name)
            print("------------------------------------------------------------")
        ...
        print(f"\nDictionary: {dictionary_name}")
        print("------------------------------------------------------------")
        out.print_dict(state, dictionary_name)
        print("------------------------------------------------------------")
